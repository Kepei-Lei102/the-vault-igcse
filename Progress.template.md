# Progress 学习进度 — template

> Copy this file to `Progress.md` (your copy is never overwritten by an update)
> and let your AI tutor maintain it. One row per card. Statuses:

> `?` no knowledge either way · `?🟢` / `?🟡` / `?🔴` a *guess* from your
> background · `🔴` not met yet · `🟡` know of it, checkpoint pending · `🟢` a
