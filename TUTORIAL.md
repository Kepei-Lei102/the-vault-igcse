...
no-git path: download the latest `The_Vault_IGCSE_2026.zip` from
<https://github.com/Kepei-Lei102/the-vault-igcse/releases> and unzip it.

```bash
curl -L -o vault.zip https://github.com/Kepei-Lei102/the-vault-igcse/releases/latest/download/The_Vault_IGCSE_2026.zip && unzip -q vault.zip && rm vault.zip
```
...
gh repo clone Kepei-Lei102/the-vault-igcse -- --depth 1
```
...
lost. Open <https://github.com/Kepei-Lei102/the-vault-igcse/releases>, download
`The_Vault_IGCSE_2026.zip`, and double-click it to unzip. It's about 400 MB, mostly
