...
- **The same $k$ elsewhere:** **Information Theory** *(not yet released)* — Boltzmann's $S = k\ln W$ is Shannon's entropy in physics units, and the thermal-noise floor $k_BT$ caps every communication channel.
