...
- **CS bridge — reserved:** **Recursion** *(not yet released)* — AP and GP are linear recurrences of order 1; generalising to higher order gives Fibonacci and the whole recurrence-solving toolkit
